...
**0.25.0**。完整功能、开发和打包说明见 [Desktop README](desktop/README.md)。

> 0.25.0 将生成历史升级为可搜索、筛选和分页限制的主从式历史中心，支持直接试听、复制原文与
> 实际发音文本、下载音频/逐句 ZIP/字幕/报告，以及安全地在输出文件夹中定位结果；生成完成后历史自动刷新。
